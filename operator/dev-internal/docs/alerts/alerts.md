...
1. Ensure that you have the information for the required fields:
   ...
   - **Cluster name**. For example, the value of `clusterName` from your Wavefront Custom Resource configuration (ex: [wavefront.yaml](../../deploy/scenarios/wavefront-getting-started.yaml)).
