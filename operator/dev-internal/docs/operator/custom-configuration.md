...
| Operations for Applications logging | `projects.registry.vmware.com/tanzu_observability/kubernetes-operator-fluentbit:2.1.4` | `YOUR_IMAGE_REGISTRY/kubernetes-operator-fluentbit:2.1.4` |
