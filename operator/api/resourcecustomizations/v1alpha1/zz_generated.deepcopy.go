...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TolerationsCustomization) DeepCopyInto(out *TolerationsCustomization) {
	*out = *in
	if in.Add != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TolerationsCustomization.
func (in *TolerationsCustomization) DeepCopy() *TolerationsCustomization {
	if in == nil {
		return nil
	}
	out := new(TolerationsCustomization)
	in.DeepCopyInto(out)
	return out
}
