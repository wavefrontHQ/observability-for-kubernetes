...
By the end, you will see Application Maps in OpApps showing connections between microserverices on a given Kuberenetes cluster. You'll also get Request, Error, and Duration (RED) metrics between those connections.
