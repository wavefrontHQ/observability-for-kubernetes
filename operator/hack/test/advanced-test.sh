...
exit_on_fail \
  ...
  "at(%22end%22%2C%202m%2C%20ts(kubernetes.cadvisor.container.cpu.cfs.throttled.seconds.total.counter%2C%20cluster%3D%22${K8S_CLUSTER_NAME}%22%20AND%20namespace_name%3D%22${OPERATOR_NAMESPACE}%22%20AND%20pod_name%3D%22${PROXY_POD_NAME}%22%20AND%20container_name%3D%22${PROXY_CONTAINER_NAME}%22))"
