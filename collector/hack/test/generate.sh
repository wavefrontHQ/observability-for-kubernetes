...
function copy_collector_deployment_files() {
  ...
  cp base/deploy/collector-deployments/5-collector-cluster-metrics-only.yaml base/deploy/collector-deployments/5-collector-k8s-events-only.yaml
