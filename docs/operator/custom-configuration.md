...
| Component | From | To |
|---|---|---|
| Observability for Kubernetes Operator | `projects.registry.vmware.com/tanzu_observability/kubernetes-operator:2.11.0` | `YOUR_IMAGE_REGISTRY/kubernetes-operator:2.11.0` |
| Kubernetes Metrics Collector | `projects.registry.vmware.com/tanzu_observability/kubernetes-collector:1.23.0` | `YOUR_IMAGE_REGISTRY/kubernetes-collector:1.23.0` |
